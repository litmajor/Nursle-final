  ...
  const features = [
    {
      ...
      title: "Smart Triage",
      description:
        "AI-powered patient assessment that helps prioritize care based on symptoms and severity.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Comprehensive patient timeline tracking for better informed healthcare decisions.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Real-time insights into patient flow, triage efficiency, and predictive healthcare analytics.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "HIPAA-compliant data handling with robust security measures for patient privacy protection.",
    },
  ];
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                Empowering healthcare professionals with AI-driven patient
                assessment, streamlined workflows, and intelligent analytics for
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Everything you need to deliver efficient, accurate, and
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of healthcare professionals who trust Nursle for
              efficient patient triage and care management.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-gray-300 mb-4 max-w-md">
                Revolutionizing healthcare with intelligent triage solutions
                that prioritize patient care and streamline medical workflows.
              </p>
              <p className="text-sm text-gray-400">
                © 2024 Nursle. All rights reserved.
              </p>
            </div>
