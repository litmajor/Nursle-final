...
const Toast = ({ message, type = 'info', duration = 4000, onClose }) => {
  ...
  return (
    <div className={`fixed top-4 right-4 max-w-sm w-full bg-white dark:bg-gray-800 border rounded-lg shadow-lg p-4 z-50 transform transition-all duration-300 ${typeStyles[type]}`}>
